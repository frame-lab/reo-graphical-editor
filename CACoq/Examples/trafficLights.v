...
(* It requires the compilation of CaMain.v file in https://github.com/frame-lab/ReoXplore. *) 
...
Inductive merger1StatesType := 
	q0.
Instance merger1EqDec : EqDec merger1StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q0 , q0 => in_left 
	end
...
Inductive sync2StatesType := 
	q1.
Instance sync2EqDec : EqDec sync2StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q1 , q1 => in_left 
	end
...
Inductive sync3StatesType := 
	q2.
Instance sync3EqDec : EqDec sync3StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q2 , q2 => in_left 
	end
...
Inductive transformer5StatesType := 
	q4.
Instance transformer5EqDec : EqDec transformer5StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q4 , q4 => in_left 
	end
...
Inductive sync6StatesType := 
	q5.
Instance sync6EqDec : EqDec sync6StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q5 , q5 => in_left 
	end
...
Inductive sync7StatesType := 
	q6.
Instance sync7EqDec : EqDec sync7StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q6 , q6 => in_left 
	end
...
Inductive fifo8StatesType := 
	 q7 | 	 p0 | 	p1.
Instance fifo8EqDec : EqDec fifo8StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q7 , q7 => in_left 
		| q7 , p0 => in_right 
...
Inductive merger9StatesType := 
	q8.
Instance merger9EqDec : EqDec merger9StatesType eq :=
	{equiv_dec x y := 
		 match x, y with 
		| q8 , q8 => in_left 
	end
